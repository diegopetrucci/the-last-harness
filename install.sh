...
TMP_DIR=""
ORIGINAL_ARGS=("$@")
TLH_SUBAGENT_PROMPTS=(developer.md staff-developer.md test-runner.md code-reviewer.md repo-scout.md diff-summarizer.md librarian.md oracle.md contrarian.md web-scout.md)
