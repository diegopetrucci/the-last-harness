...
export function assertOwnedWorkspacePath(root, path) {
...
export function createBenchmarkWorkspace(parentRoot) {
...
function inheritedSafeEnvironment(source) {
    const safe = {};
...
export function buildChildEnvironment(workspace, source = process.env, { ref = DEFAULT_REF } = {}) {
...
export function writeCredentialFreeTrustMetadata(workspace) {
