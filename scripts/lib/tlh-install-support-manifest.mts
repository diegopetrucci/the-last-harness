...
export function supportFileManifest({
  noSettings = false,
}: SupportFileManifestOptions = {}): SupportFileDescriptor[] {
...
export function requiredSupportFiles(
  options: SupportFileManifestOptions = {},
): SupportFileDescriptor[] {
  return supportFileManifest(options).filter((file) => file.requirement === REQUIRED);
}

export function installableSupportFiles(
  options: SupportFileManifestOptions = {},
): SupportFileDescriptor[] {
