...
function spawnErrorCode(error: NodeJS.ErrnoException | Error | undefined): string | number | undefined {
	return error && "code" in error ? error.code : undefined;
}

function installManagedRtk(args: CliArgs, env: ProcessEnvMap): void {
