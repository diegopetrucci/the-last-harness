...
const PACKAGED_SCRIPT_FILES = [
  ...
  "scripts/lib/session-analysis-coverage.mts",
  "scripts/lib/subagent-analysis-types.mjs",
  "scripts/lib/subagent-analysis-types.mts",
  "scripts/lib/subagent-analysis-validation.mjs",
  "scripts/lib/subagent-analysis-validation.mts",
  "scripts/lib/subagent-analysis-aggregation.mjs",
  "scripts/lib/subagent-analysis-aggregation.mts",
  "scripts/lib/subagent-analysis-parser.mjs",
  "scripts/lib/subagent-analysis-parser.mts",
  "scripts/lib/subagent-analysis-wakeup.mjs",
  "scripts/lib/subagent-analysis-wakeup.mts",
  "scripts/lib/subagent-analysis.mjs",
  "scripts/lib/subagent-analysis.mts",
  "scripts/lib/subagent-analysis-keys.mjs",
  "scripts/lib/subagent-analysis-keys.mts",
  "scripts/lib/tlh-install-git.mjs",
  "scripts/lib/tlh-install-git.mts",
  "scripts/lib/tlh-install-npm.mjs",
  "scripts/lib/tlh-install-npm.mts",
  ...
  "scripts/lib/tlh-install-profile-cleanup.mjs",
  "scripts/lib/tlh-install-profile-cleanup.mts",
