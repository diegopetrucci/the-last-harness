...
import { normalizeEnabledExperimentalFeatures, normalizeExperimentalFeatureId, readEnabledExperimentalFeatures, STAFF_DEVELOPER_ROUTING_FEATURE, } from "../the-last-harness-subagent-safety.mjs";
...
export const TLH_EXPERIMENTAL_FEATURES = [
    ...
    },
    {
        ...
        description: "Architect guidance for disabled-by-default semantic developer and staff-developer ticket routing, visible reasons, counts, and approval sequencing.",
        primaryAgentPrompts: {
