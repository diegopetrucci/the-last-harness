...
export const TLH_EXPERIMENTAL_FEATURES = [
    ...
    },
    {
        ...
        description: "Opt-in aggregate-only in-process session source observation with deferred snapshots; reply channel is enabled automatically with the observer.",
        telemetry: false,
