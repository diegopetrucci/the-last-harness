...
export function registerExperimentalCommand(
  pi: ExtensionAPI,
  options: TlhExperimentalCommandFacadeOptions = {},
): void {
  const loadModule = createRetryableLazyImport(
    options.loadModule ??
      (() => import("./experimental-command.js") as Promise<ExperimentalCommandModule>),
  );
