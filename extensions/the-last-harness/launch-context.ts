...
function activeToolsForEstimate(activeToolNames: readonly string[], allTools: readonly ToolInfo[]): ToolInfo[] {
...
function tokenAllocationFromChars(chars: TlhLaunchContextCharacterAllocation): TlhLaunchContextTokenAllocation {
	return {
