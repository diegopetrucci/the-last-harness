export const TLH_STARTUP_TIPS = [
    ...
    "Use Pi Voice: run /voice-settings once to choose a local model, then press Ctrl+Alt+Z to start and stop dictation; /transcribe remains a compatibility alias for /voice-settings.",
