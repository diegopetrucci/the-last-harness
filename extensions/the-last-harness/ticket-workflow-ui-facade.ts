...
import { createTlhTicketWorkflowUiRuntime, type TlhTicketWorkflowUiRuntime } from "./ticket-workflow-ui.js";
...
export function registerLazyTlhTicketWorkflowUi(
	...
	const runtimeFactory = options.createRuntime ?? ((api: ExtensionAPI) => createTlhTicketWorkflowUiRuntime(api));
