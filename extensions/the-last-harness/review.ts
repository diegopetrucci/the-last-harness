...
/**
 * Handler body for the /review command. Exported so the extension entry can
 * lazily import this module and delegate without re-registering the command.
 */
export async function reviewCommandHandler(pi: ExtensionAPI, args: string, ctx: ExtensionCommandContext): Promise<void> {
