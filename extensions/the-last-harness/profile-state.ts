...
export function safeTlhProfileFilePath(relativePath: string): string | undefined {
  ...
  try {
    ...
    if (
      !pathWithinOrEqual(resolvedAgentDir, resolvedTargetPath) ||
 ...
 */
function writeTlhStateFileAtomicallyCore(
  statePath: string,
  content: string,
...
export function withLockedTlhSettingsWrite<
  TResult extends { changed: boolean; nextContent?: string | undefined },
>(
  cwd: string,
