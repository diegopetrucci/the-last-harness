...
describe(
  "slash live state",
  { skip: !available ? "slash-live-state.ts not importable" : undefined },
  () => {
    ...
    it("rerenders the active slash surface from shared live-detail state", () => {
      ...
      const component = createSlashResultComponent!(
        details,
        { expanded: true },
        theme as never,
        controller,
    ...
    it("keeps finalized slash results on the live-detail controller", () => {
      ...
      const collapsed = createSlashResultComponent!(
        collapsedDetails,
        { expanded: true },
        theme as never,
        controller,
      ...
      assert.equal(controller.toggle(), true);
      const expanded = createSlashResultComponent!(
        expandedDetails,
        { expanded: false },
        theme as never,
        controller,
