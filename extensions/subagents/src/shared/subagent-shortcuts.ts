 ...
 */
export function createSubagentLiveDetailController(initialExpanded = false): SubagentLiveDetailController {
	...
	const scheduleProbe = (toolCallId: string, rendererState: object, invalidate: () => void): void => {
