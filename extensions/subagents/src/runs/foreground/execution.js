...
export async function runSync(runtimeCwd, agents, agentName, task, options) {
    ...
    const attemptNotes = [];
    const contextPressureCrossedThresholds = new Set(options.contextPressureCrossedThresholds ?? []);
    let contextPressure;
