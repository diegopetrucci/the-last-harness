...
import { buildCohortPauseStep, buildPausedStepFromResult, indexedLifecycleContinuation, isClaimedPausedLifecycle, isTerminalForegroundResultSnapshot, pausedForegroundStatusPath, pausedForegroundTerminationReason, persistPausedForegroundCohortRun, persistPausedForegroundSingleRun, } from "./foreground-pause-state.js";
...
import { resolveExecutionPolicy, remainingExecutionTimeMs, } from "../../agents/execution-ceiling.js";
...
import { lifecycleContinuationForIndex, lifecycleGeneration, normalizeActiveRuntimeCheckpointAt, normalizeActiveRuntimeMs, markLifecycleContinuationSpawned, recoverStaleLifecycleContinuationClaim, recoverStaleLifecycleContinuationStatus, transitionLifecycleStatus, withLifecycleContinuation, withLifecycleStatusLock, writeNormalizedLifecycleStatus, } from "../shared/lifecycle-state.js";
...
function resetForegroundControlHealth(control) {
...
function updateForegroundControlProgress(control, progress) {
...
function clearForegroundControlEphemeralHealth(control) {
    control.currentActivityState = undefined;
    control.idleEpisodeId = undefined;
    control.compaction = undefined;
}
