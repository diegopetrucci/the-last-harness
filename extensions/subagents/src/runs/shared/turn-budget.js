...
export function turnBudgetSoftNote(budget, turnCount) {
...
export function turnBudgetExceededMessage(budget, turnCount) {
...
export function turnBudgetState(budget, turnCount, exceeded) {
    return {
        ...budget,
        turnCount,
...
export function shouldAbortForTurnBudget(budget, turnCount, terminalAssistantStop) {
