 ...
 *
 * Full whimsical thinking phrase pool adapted from mitsuhiko/agent-stuff's
 * `extensions/whimsical.ts` at commit d265b8ef32f896d3ef3bc6a45bd7b8e0d02150e0.
 * Copyright (c) mitsuhiko/agent-stuff contributors.
 *
 * Source: https://github.com/mitsuhiko/agent-stuff/blob/d265b8ef32f896d3ef3bc6a45bd7b8e0d02150e0/extensions/whimsical.ts
 * Licensed under Apache-2.0; license text:
 * https://github.com/mitsuhiko/agent-stuff/blob/d265b8ef32f896d3ef3bc6a45bd7b8e0d02150e0/LICENSE
 */
export const WHIMSICAL_THINKING_PHRASES = [
  // Short
  "Schlepping...",
  "Combobulating...",
  "Doing...",
...
function deterministicPhrasePermutation(length: number): number[] {
  ...
  let state = WHIMSICAL_SHUFFLE_SEED;
