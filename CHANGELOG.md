...
- Temporarily pinned TLH package metadata, peer-compatibility guidance, and install/update docs to upstream Pi 0.79.7 while the then-current upstream 0.79.8 breakage was active.
