...
Gnosis project-memory and `tk` ticket integration details, opt-out flags, management commands, and data-removal notes live in [`docs/integrations.md`](docs/integrations.md).
