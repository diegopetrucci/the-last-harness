...
Project-local `.tlh/defaults.json` model/effort defaults are no longer loaded. Packaged defaults and isolated-profile overrides remain supported; bundled minor roles can be customized through `/subagent-settings`. See [docs/models.md](docs/models.md#project-modeleffort-defaults).
