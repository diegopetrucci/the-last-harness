...
- TLH spends tokens to save human attention: isolated developers, reviewers, research, and validation are a feature, not waste.
- The core loop is non-negotiable: think through the work with the architect, approve it, then switch to something else while TLH executes.
