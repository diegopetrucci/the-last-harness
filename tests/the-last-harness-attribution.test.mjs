...
printf 'extra'
  ...
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedWrappedInlineMessage, enabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedWrappedInlineMessageWithTerminator, enabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedEnvInlineMessage, enabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedQualifiedEnvInlineMessage, enabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedUnsetEnvInlineMessage, enabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedPathEnvInlineMessage, enabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedUnsupportedEnvInlineMessage, enabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedUnsupportedEnvWrappedInlineMessage, enabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedSplitStringCombinedCommit, enabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(
      attributedLongSeparatedSplitStringCombinedCommit,
      enabled,
    ),
    undefined,
  );
  ...
  assert.equal(
    getTlhGitCommitAttributionBlockReason(
      attributedShortQuotedSplitStringWrappedCommitWithTerminator,
      enabled,
    ),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedLongQuotedSplitStringWrappedCommit, enabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedOptionTerminatedSplitStringCommit, enabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(
      attributedOptionTerminatedSplitStringWrappedCommit,
      enabled,
    ),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedShellOptionWrappedInlineMessage, enabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(
      attributedShellOptionWrappedInlineMessageWithTerminator,
      enabled,
    ),
    undefined,
  );
  ...
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedProcessSubstitution, enabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(
      attributedPrintfEscapedNewlineProcessSubstitution,
      enabled,
    ),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedEchoProcessSubstitution, enabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedHereDocProcessSubstitution, enabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedLastFileProcessSubstitution, enabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason("git commit -F .git/COMMIT_EDITMSG", enabled),
    undefined,
  );
...
test("git commit attribution guard blocks qualified git commit paths", () => {
  ...
  for (const command of [
    unattributedQualifiedGitCommit,
    unattributedEnvWrappedQualifiedGitCommit,
  ]) {
    assert.match(
      getTlhGitCommitAttributionBlockReason(command, enabled) ?? "",
      /missing the required TLH attribution footer/,
...
EOF`;
  ...
  assert.equal(
    getTlhGitCommitAttributionBlockReason(attributedEnvSplitWrappedHereDoc, enabled),
    undefined,
  );
  assert.match(
  ...
  assert.equal(
    getTlhGitCommitAttributionBlockReason(unattributedWrappedHereDoc, disabled),
    undefined,
  );
  assert.equal(
    getTlhGitCommitAttributionBlockReason(unattributedEnvSplitWrappedHereDoc, disabled),
    undefined,
  );
});
...
test("toggle attribution command disables the default footer by writing false", async (t) => {
  ...
  await withEnv({ HOME: fixture.home, PI_CODING_AGENT_DIR: fixture.agent }, async () => {
    ...
    assert.equal(
      readdirSync(fixture.agent).filter((entry) => entry.startsWith("settings.json.bak-")).length,
      0,
    );
...
test("toggle attribution command re-enables by writing true and creating a backup", async (t) => {
  ...
  await withEnv({ HOME: fixture.home, PI_CODING_AGENT_DIR: fixture.agent }, async () => {
    ...
    assert.deepEqual(written, {
      tlh: { attribution: { commit: true }, gnosis: { enabled: true } },
    });
    assert.equal(
      readFileSync(settingsPath, "utf8").includes(TLH_DEFAULT_COMMIT_ATTRIBUTION),
      false,
    );
