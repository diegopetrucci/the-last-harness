...
test("review UI inlines commit reconciliation before app refresh handling", async () => {
  ...
  assert.ok(
    appCallIndex > helperIndex,
    "app refresh handling must call the helper after it is defined",
  );
