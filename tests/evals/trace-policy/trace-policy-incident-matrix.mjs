export const TRACE_POLICY_INCIDENT_MATRIX = [
  ...
  },
  {
    ...
    incident: "gh-241",
    invariant:
      "Architect may not directly mutate source files; implementation belongs to developer after approvals.",
    sourceKind: "synthetic",
    coverage: {
      status: "covered",
      fixtureIds: [
  ...
  },
  {
    ...
    coverage: {
      ...
      fixtureIds: [
        ...
        "developer-invalid-pre-existing-changes-bare-dot-checkout",
        "developer-invalid-pre-existing-changes-bare-dotdot-checkout",
