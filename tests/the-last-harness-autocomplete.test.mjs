...
test("autocomplete hides configured slash commands only in slash-command-name context", async () => {
	const suggestions = {
		items: [
			...
			{ value: "subagents-profiles", label: "/subagents-profiles" },
			{ value: "subagents-check-profile", label: "/subagents-check-profile" },
			{ value: "subagents-models", label: "/subagents-models" },
			{ value: "skill:pi-subagents", label: "/skill:pi-subagents" },
			{ value: "skill:librarian", label: "/skill:librarian" },
			{ value: "skill:pi-intercom", label: "/skill:pi-intercom" },
