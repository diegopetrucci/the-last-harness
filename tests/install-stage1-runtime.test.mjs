...
// user-owned ~/.local/bin/pi@0.81.1 present.  The installer must provision the private
...
test("stage-1 regression (tlht-5php): installer never removes or execs user-owned ~/.local/bin/pi when piInstalledByTlh=true and private runtime is absent", (t) => {
	...
	// User-owned ~/.local/bin/pi@0.81.1 — must NOT be removed or invoked by the installer.
